...
runners.forEach(function(value, index) {
...
allCaps = runners.map(function(value, index){
...
let largeShirts = [];
largeShirts = runners.filter(function(value, index){
...
ticketPriceTotal = runners.reduce(function(accumulator, value) {
  return  ticketPriceTotal += value['donation'];  
})
